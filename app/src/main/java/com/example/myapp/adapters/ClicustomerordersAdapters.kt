...
class ClicustomerordersAdapters(private val userList: MutableList<shocustomersorders>, private val onItemClick: (shocustomersorders) -> Unit) : RecyclerView.Adapter<ClicustomerordersAdapters.UserViewHolder>() {
